...
INSERT INTO dim_store
       (store_name, location, city, state, country_id, phone, email)
...
INSERT INTO dim_supplier
       (supplier_name, contact, email, phone, address, city, country_id)
...
SELECT 'Проверка на легит: колво строк по таблицам' AS info;
